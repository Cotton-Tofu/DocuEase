...
{
    public partial class PrintErrorDialog : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public PrintErrorDialog()
        {
            InitializeComponent();
        }

        private void PrintErrorDialog_Load(object sender, EventArgs e)
        {
            //Office2007青色
        ...
        private void PrintErrorDialog_Shown(object sender, EventArgs e)
        {
