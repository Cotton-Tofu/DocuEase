...
{
    public partial class AddressDeleteError : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public AddressDeleteError()
        {
            InitializeComponent();
        }

        private void AddressDeleteError_Shown(object sender, EventArgs e)
        {
            System.Media.SystemSounds.Hand.Play();
        }

        private void AddressDeleteError_Load(object sender, EventArgs e)
        {
            //Office2007青色
