...
namespace Document_Maker
{
    public partial class ThirdParty : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        ...
        {
            System.Diagnostics.Process.Start("https://www.nuget.org/packages/AeroWizard");
        }
        ...
        {
            System.Diagnostics.Process.Start("https://www.nuget.org/packages/Microsoft.Web.WebView2/1.0.3595.46?_src=template");
        }

        private void kryptonButton6_Click_1(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/7.1.3?_src=template");
        }

        private void kryptonButton10_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://learn.microsoft.com/ja-jp/dotnet/desktop/winforms/overview/");
        }

        private void kryptonButton11_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://icons8.jp/icons/set/pichon");
        }
    }
}
