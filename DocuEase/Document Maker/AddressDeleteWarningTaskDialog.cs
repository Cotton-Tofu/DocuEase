...
{
    public partial class AddressDeleteWarningTaskDialog : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public AddressDeleteWarningTaskDialog()
        {
            InitializeComponent();
        }

        private void AddressDeleteWarningTaskDialog_Shown(object sender, EventArgs e)
        {
            System.Media.SystemSounds.Asterisk.Play();
        }

        private void AddressDeleteWarningTaskDialog_Load(object sender, EventArgs e)
        {
            //Office2007青色
